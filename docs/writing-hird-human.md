...
| `hird effect-diff <baseline> <input> [--json]` | Diff the effect graph against a committed baseline; exit nonzero when effect reach widens. See [`effect-graph.md`](effect-graph.md). |
